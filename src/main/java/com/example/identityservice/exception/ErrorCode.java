...
public enum ErrorCode {
    ...
    USERNAME_INVALID(1002, HttpStatus.BAD_REQUEST,"Username must be at least {min} characters"),
    PASSWORD_INVALID(1003, HttpStatus.BAD_REQUEST,"Password must be at least {min} characters."),
